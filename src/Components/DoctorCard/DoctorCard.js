...
const DoctorCard = ({ name, speciality, experience, ratings, profilePic }) => {
    ...
    useEffect(() => {
        const getAppointments = JSON.parse(localStorage.getItem('appointmentData')) || [];
    ...
    const handleCancel = (appointmentId) => {
        ...
        localStorage.setItem('appointmentData', JSON.stringify(updatedStoredAppointments));
    ...
    const handleFormSubmit = (appointmentData) => {
        ...
        localStorage.setItem('doctorData', JSON.stringify({ name, speciality })); // Store doctor name for Notification
    ...
    return (
        <div className="doctor-card-container">
            ...
            <div className="doctor-card-options-container">
                ...
                >
                    {(close) => (
                        <div className="doctorbg" style={{ overflow: 'auto', padding: '20px' }}>
                            <div>
                                <div className="doctor-card-profile-image-container">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16"> <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" /> </svg>
                                </div>
